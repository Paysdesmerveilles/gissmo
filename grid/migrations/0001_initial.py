    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('built', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='place.Built')),
                ('configuration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipment.Configuration')),
