    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.FileField(
                ...
                storage=django.core.files.storage.FileSystemStorage(
                    location='/home/olivier/gissmo/upload')),
        ),
        migrations.AlterField(
            model_name='equipdoc',
            name='equip',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                ...
                choices=[
                    ...
                    (4, 'Désinstaller'),
                    (5, 'Constater défaut'),
                    (6, 'Effectuer maintenance préventive à distance'),
                    (7, 'Effectuer maintenance corrective à distance'),
                    (8, 'Effectuer maintenance préventive sur site'),
                    (9, 'Effectuer maintenance corrective sur site'),
                    (10, 'Expédier'),
                    (11, 'Recevoir'),
                    (12, 'Mettre hors usage'),
                    (13, 'Constater disparition'),
                    (14, 'Retrouver suite à une disparition'),
                    (15, 'Mettre au rebut'),
                    (16, 'Autre')]),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                verbose_name='action',
                choices=[
                    (1, 'Créer code station'),
                    (2, 'Installer station'),
                    (11, 'Débuter test'),
                    (12, 'Terminer test'),
                    (3, 'Mettre en opération'),
                    (4, 'Constater défaillance'),
                    (5, 'Effectuer maintenance préventive à distance'),
                    (6, 'Effectuer maintenance corrective à distance'),
                    (7, 'Effectuer maintenance préventive sur site'),
                    (8, 'Effectuer maintenance corrective sur site'),
                    (9, 'Démanteler'),
                    (10, 'Autre')]),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                ...
                choices=[
                    (1, 'Station sismologique'),
                    (6, 'Site de test'),
                    (7, 'Site théorique'),
                    (2, 'Observatoire'),
                    (3, 'Lieu de service après vente'),
                    (4, 'Lieu indéterminé'),
                    (5, 'Autre')]),
        ),
    ]
